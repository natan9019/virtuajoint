...
-- -----------------------------------------------------
-- Table `virtuajoint`.`Usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `virtuajoint`.`Usuarios` (
  ...
  `regDate` DATETIME(6) NOT NULL COMMENT 'Registro de tiempo de la creación del usuario',
