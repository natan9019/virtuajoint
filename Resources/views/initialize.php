...
<head>
    ...
    <title>Administrar - Virtuajoint</title>
    ...
    <div class="main">
        <section id="formInitializeContainer" class="initializeSection">
            <div class="initialize-instrucciones">
                <h1>Administrar el sistema VirtuaJoint</h1>
                <h2>Inicializar: Deja los valores por default para un entorno local</h2>
            </div>
        ...
        <section id="formDeleteContainer" class="initializeSection">
            <div class="initialize-instrucciones">
                <h2>Eliminar: Destruir la base de datos de Virtuajoint</h2>
            </div>

            <form action="/Resources/views/deleteSystemDB.php" method="POST" class="form-initialize">
                <fieldset class="fieldset-initialize">
                    <legend>Conexión al servidor de base de datos</legend>
                    <label for="lblServerName">Selecciona un servidor:</label>
                    <!-- <input type="text" id="txtServerName" name="txtServerName" value="localhost"><br> -->
                ...
                <fieldset class="fieldset-initialize">
                    ...
                    <input type="submit" id="btnDelete" value="Eliminar BD">
                </fieldset>
