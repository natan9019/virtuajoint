...
<body>
    ...
    <div class="main" id="main" style="margin-left: 180px;">
        <div class="w3-container" style="display: initial;">
            ...
            <h3 class="h3" >Baja de marcas Jugueteras</h3>
            <?PHP
                ...
                if($_SERVER["REQUEST_METHOD"] == "POST")
                {
                    ...
                    $nombrePais = test_input($_POST["txtNombrePaisBaja"]);
                ...
                try 
                {
                    $sqlInsert = "DELETE FROM paises WHERE nombrePaises='$nombrePais'";
