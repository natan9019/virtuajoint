                ...
                <?PHP                    
                    ...
                    try 
                    {
                        ...
                        $sqlQueryCreateTable = "CREATE TABLE `users` (
                            ...
                            `idPaisUser` VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'Nacionalidad del usuario' COLLATE 'utf8mb4_general_ci',
                    ...
                    try
                    {
                        ...
                        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                        //Metemos en una variable el código SQL a ejecutar:
                        $sqlInsertInTable = "INSERT INTO users (idUser, userFName, userLName, aliasUser, idPaisUser, genderUser, emailUser, hashPsswdUser, websiteUser)
